    ...
    <>
      <div
        className={`max-w-screen-2xl container mx-auto md:px-20 px-4 ${
          sticky
            ? 'sticky top-0 bg-base-300 dark:bg-slate-400 shadow-md transition-all duration-300 z-50'
            : ''
        }`}
      >
        <div className="navbar">
          ...
          <div className="navbar-end space-x-3">
            ...
            {authUser ? (
              ...
              <div>
                <a
                  className="bg-black px-3 py-1 rounded-md text-white hover:bg-slate-800 duration-300 cursor-pointer"
